...
def _extract_interpreters(context: t.MutableMapping) -> t.Optional[t.Mapping[str, t.Sequence[str]]]:
...
def _parse_interpreters_from_string(interpreters: str) -> t.Optional[t.Mapping[str, t.Sequence[str]]]:
