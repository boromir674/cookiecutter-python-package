...
def sdist_expected_correct_file_structure():
    ...
    SRC = tuple(
        ...
        # GITHUB ACTIONS - TEMPLATE Workflows and config
        'src/cookiecutter_python/{{ cookiecutter.project_slug }}/.github/workflows/build-n-test.yml',
    ...
    TESTS = (
        ...
        'tests/data/snapshots/biskotaki-gold-standard/CHANGELOG.md',
        ...
        'tests/data/snapshots/biskotaki-gold-standard/README.md',
        ...
        'tests/data/snapshots/biskotaki-interactive/CHANGELOG.md',
        ...
        'tests/data/snapshots/biskotaki-interactive/README.md',
        ...
        'tests/data/snapshots/biskotaki-no-input/CHANGELOG.md',
        ...
        'tests/data/snapshots/biskotaki-no-input/README.md',
        ...
        'tests/data/snapshots/biskotaki-gold-standard/.github/workflows/build-n-test.yml',
        ...
        'tests/data/snapshots/biskotaki-interactive/.github/workflows/build-n-test.yml',
        ...
        'tests/data/snapshots/biskotaki-no-input/.github/workflows/build-n-test.yml',
